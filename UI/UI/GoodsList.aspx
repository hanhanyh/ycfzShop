<%@ Page Title="商品列表" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GoodsList.aspx.cs" Inherits="UI.GoodsList" %>
...
<div class="container">
	<ol class="breadcrumb"  class="mbxnav" style="margin-bottom: 0;margin-left:0;padding-left:0;background: transparent;">
    		...
    		<li class="active">商品自览</li>
    </ol>
    <div>
    	<img src="img/goodslistview/goodlistview.jpg" width="100%" /> 
    </div>
	<div id="selmenu">
		<div>
			 <%/*商品分类条*/ %>
            <asp:Repeater ID="RepeaterGoodsType" runat="server">
                <HeaderTemplate>
                    <ul id="selectmenul0" class="typeul">
                </HeaderTemplate>
                <ItemTemplate>
                    <li><a href="GoodsList.aspx?GTID=<%#Eval("GTID") %>&page=<%=_page%>"><%#Eval("Name") %></a></li>
                </ItemTemplate>
                <FooterTemplate>
                    </ul>
                </FooterTemplate>
