<%@ Page Title="待发货订单" Language="C#" MasterPageFile="~/Admin/AdminSite1.Master" AutoEventWireup="true" CodeBehind="OrderWaiting.aspx.cs" Inherits="UI.Admin.OrderWaiting" %>
            ...
            <asp:TemplateField>
             ...
             <asp:TemplateField>
                ...
                <ItemTemplate>
                  ...
                  <asp:LinkButton runat="server" CommandName="SendGoods"   CommandArgument='<%#Eval("订单ID") %>' Text="发货" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
